...
#문서1과 문서2의 유사도 분석
print("문석1과 문서2의 유사도 : "+ str(cos_sim(result[0], result[1])))

#문서1과 문서3의 유사도 분석
print("문석1과 문서3의 유사도 : "+ str(cos_sim(result[0], result[2])))

#문서1과 문서4의 유사도 분석
print("문석1과 문서4의 유사도 : "+ str(cos_sim(result[0], result[3])))

#문서1과 문서5의 유사도 분석
print("문석1과 문서5의 유사도 : "+ str(cos_sim(result[0], result[4])))

#문서1과 문서6의 유사도 분석
print("문석1과 문서6의 유사도 : "+ str(cos_sim(result[0], result[5])))
